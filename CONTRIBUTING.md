...
By contributing, you agree that your contribution is licensed under GPL-3.0-or-later. You also grant the Ulpaso maintainers a non-exclusive, irrevocable, perpetual, worldwide, royalty-free right to use, reproduce, modify, distribute, sublicense, and relicense your contribution in official Ulpaso products, including commercially licensed products. Submit only work for which you have the authority to grant both permissions.
