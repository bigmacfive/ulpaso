...
const en = {
  ...
  "settings.meetingAutoStart": "Automatic meeting detection",
  "settings.meetingAutoStartDescription": "Starts notes after a meeting app uses the microphone",
  "settings.on": "On",
  "settings.off": "Off",
  ...
  "confirm.body.close": "You can save your work before closing the app. Continuing without saving will discard your latest changes.",
  ...
  "meeting.autoDetected": "{app} meeting detected · Starting notes automatically",
