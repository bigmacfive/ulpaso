...
const en = {
  ...
  "settings.editorWidthDescription": "Use the full window or a focused page",
  "settings.editorWidthFocused": "Focused",
  "settings.editorWidthFull": "Full width",
  ...
  "settings.localData": "Downloaded AI models",
  "settings.localDataDescription": "Remove speech and speaker models plus recovery audio. Documents stay untouched.",
  "settings.localDataRemove": "Remove…",
  "settings.localDataConfirm": "Remove models & audio",
  "settings.localDataRemoving": "Removing…",
  "settings.localDataRemoved": "Removed {size} of downloaded models and recovery audio",
  "settings.localDataRemoveFailed": "Could not remove downloaded transcription models",
  "settings.audioPermissions": "Audio permissions",
  "settings.microphone": "Microphone",
  "settings.microphoneStatus.not-determined": "Permission not requested yet",
  "settings.microphoneStatus.authorized": "Allowed for Ulpaso",
  "settings.microphoneStatus.denied": "Blocked in System Settings",
  "settings.microphoneStatus.restricted": "Restricted on this Mac",
  "settings.microphoneStatus.unavailable": "Available in the Mac app",
  "settings.microphoneAllow": "Allow",
  "settings.microphoneAllowed": "Allowed",
  "settings.microphoneOpenSettings": "Open Settings",
  "settings.microphoneRequesting": "Waiting…",
  "settings.microphoneDenied": "Allow microphone access to record meeting notes.",
  "settings.meetingAutoStart": "Meeting detection",
  "settings.meetingDetection": "Meeting detection",
  "settings.meetingAutoStartDescription": "Asks before recording when a meeting app uses the microphone",
  "settings.meetingDetectionDescription": "Asks before recording when a meeting app uses the microphone",
  "settings.on": "On",
  "settings.off": "Off",
  ...
  "update.title": "Ulpaso {version} is ready",
  "update.body": "Install the update and restart once to finish.",
  "update.later": "Later",
  "update.install": "Update",
  "update.installing": "Updating…",
  "update.installingBody": "Ulpaso will restart when the update is ready.",
  "update.errorTitle": "Update couldn't finish",
  "update.errorBody": "Check your connection and try again.",
  ...
  "meeting.autoDetected": "{app} meeting detected · Waiting for confirmation",
  "meeting.detectedApp": "Meeting app",
  "meeting.detectedTitle": "Record this meeting?",
  "meeting.detectedBody": "{app} is using the microphone. Audio and notes stay on this Mac.",
  "meeting.detectedCancel": "Not now",
  "meeting.detectedConfirm": "Start notes",
...
const ko: Partial<Record<MessageKey, string>> = {
  "settings.localData": "다운로드한 AI 모델", "settings.localDataDescription": "음성 인식·화자 구분 모델과 복구 오디오를 삭제합니다. 작성한 문서는 그대로 유지됩니다.", "settings.localDataRemove": "삭제…", "settings.localDataConfirm": "모델과 오디오 삭제", "settings.localDataRemoving": "삭제 중…", "settings.localDataRemoved": "다운로드한 모델과 복구 오디오 {size}를 삭제했습니다", "settings.localDataRemoveFailed": "다운로드한 음성 인식 모델을 삭제하지 못했습니다",
  ...
  "command.new": "새 문서", "command.open": "문서 열기", "command.save": "문서 저장", "command.saveAs": "다른 이름으로 저장", "command.theme": "테마 전환",
  ...
  "update.title": "Ulpaso {version} 업데이트", "update.body": "설치가 끝나면 앱이 한 번 재시작됩니다.", "update.later": "나중에", "update.install": "업데이트", "update.installing": "업데이트 중…", "update.installingBody": "준비가 끝나면 Ulpaso가 재시작됩니다.", "update.errorTitle": "업데이트를 마치지 못했습니다", "update.errorBody": "네트워크 연결을 확인하고 다시 시도해 주세요.", "update.retry": "다시 시도",
...
const ja: Partial<Record<MessageKey, string>> = {
  ...
  "command.new": "新規文書", "command.open": "文書を開く", "command.save": "文書を保存", "command.saveAs": "名前を付けて保存", "command.theme": "テーマ切替",
  ...
  "update.title": "Ulpaso {version} アップデート", "update.body": "インストール後、アプリが一度再起動します。", "update.later": "後で", "update.install": "アップデート", "update.installing": "アップデート中…", "update.installingBody": "準備ができるとUlpasoが再起動します。", "update.errorTitle": "アップデートを完了できませんでした", "update.errorBody": "ネットワーク接続を確認して、もう一度お試しください。", "update.retry": "再試行",
