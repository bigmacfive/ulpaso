...
const en = {
  ...
  "settings.microphoneAllow": "Allow microphone",
  "settings.microphoneAllowed": "Allowed · Settings",
  "settings.microphoneOpenSettings": "Open System Settings",
  "settings.microphoneRequesting": "Requesting…",
  "settings.microphoneStatus.not-determined": "Permission has not been requested",
  "settings.microphoneStatus.authorized": "Ulpaso is allowed in macOS Settings",
  "settings.microphoneStatus.denied": "Allow Ulpaso in Privacy & Security",
  "settings.microphoneStatus.restricted": "Access is restricted by macOS",
  "settings.microphoneStatus.unavailable": "Available in the macOS app",
  "settings.microphoneDenied": "Microphone access is off. Allow Ulpaso in System Settings.",
  "settings.meetingDetection": "Meeting detection notifications",
  "settings.meetingDetectionDescription": "Shows a macOS notification before recording",
  "settings.on": "On",
  "settings.off": "Off",
  ...
  "meeting.detectionPromptBody": "A meeting app is using audio. Recording starts only after you confirm.",
  "meeting.detectionPromptDismiss": "Not now",
  "meeting.detectionPromptStart": "Start recording",
  "meeting.detectionPromptFailed": "Could not show the meeting notification",
...
const ko: Partial<Record<MessageKey, string>> = {
  ...
  "settings.title": "설정", "settings.close": "설정 닫기", "settings.appearance": "화면", "settings.appearanceDescription": "편집기 밝기", "settings.colorTheme": "색상 테마", "settings.light": "밝게", "settings.dark": "어둡게", "settings.language": "언어", "settings.languageDescription": "인터페이스 언어", "settings.meeting": "회의 기록", "settings.meetingDescription": "기기 내 전사", "settings.meetingReady": "로컬 모델 준비됨", "settings.meetingDownload": "처음 사용 시 약 {size}의 AI 모델 다운로드", "settings.audioPermissions": "오디오 권한", "settings.microphone": "마이크", "settings.microphoneAllow": "마이크 허용", "settings.microphoneAllowed": "허용됨 · 설정", "settings.microphoneOpenSettings": "시스템 설정 열기", "settings.microphoneRequesting": "요청 중…", "settings.microphoneStatus.not-determined": "아직 권한을 요청하지 않았습니다", "settings.microphoneStatus.authorized": "macOS 설정에서 Ulpaso가 허용됨", "settings.microphoneStatus.denied": "개인정보 보호 및 보안에서 Ulpaso를 허용하세요", "settings.microphoneStatus.restricted": "macOS에서 접근이 제한됨", "settings.microphoneStatus.unavailable": "macOS 앱에서 사용할 수 있습니다", "settings.microphoneDenied": "마이크 접근이 꺼져 있습니다. 시스템 설정에서 Ulpaso를 허용하세요.", "settings.meetingDetection": "회의 감지 알림", "settings.meetingDetectionDescription": "회의를 감지하면 기록 전에 확인합니다", "settings.on": "켬", "settings.off": "끔", "settings.shortcuts": "키보드 단축키", "settings.shortcutsHint": "키보드 단축키 보기", "settings.shortcutsDescription": "?에 마우스를 올려 보기",
...
const ja: Partial<Record<MessageKey, string>> = {
  ...
  "settings.title": "設定", "settings.close": "設定を閉じる", "settings.appearance": "外観", "settings.appearanceDescription": "エディターの明るさ", "settings.colorTheme": "カラーテーマ", "settings.light": "ライト", "settings.dark": "ダーク", "settings.language": "言語", "settings.languageDescription": "インターフェース言語", "settings.meeting": "会議メモ", "settings.meetingDescription": "オンデバイス文字起こし", "settings.meetingReady": "ローカルモデル準備完了", "settings.meetingDownload": "初回利用時に約{size}のAIモデルをダウンロード", "settings.audioPermissions": "オーディオ権限", "settings.microphone": "マイク", "settings.microphoneAllow": "マイクを許可", "settings.microphoneAllowed": "許可済み · 設定", "settings.microphoneOpenSettings": "システム設定を開く", "settings.microphoneRequesting": "確認中…", "settings.microphoneStatus.not-determined": "権限はまだ要求されていません", "settings.microphoneStatus.authorized": "macOS設定でUlpasoが許可されています", "settings.microphoneStatus.denied": "プライバシーとセキュリティでUlpasoを許可してください", "settings.microphoneStatus.restricted": "macOSによりアクセスが制限されています", "settings.microphoneStatus.unavailable": "macOSアプリで利用できます", "settings.microphoneDenied": "マイクへのアクセスがオフです。システム設定でUlpasoを許可してください。", "settings.meetingDetection": "会議検出の確認", "settings.meetingDetectionDescription": "会議を検出したら記録前に確認します", "settings.on": "オン", "settings.off": "オフ", "settings.shortcuts": "キーボードショートカット", "settings.shortcutsHint": "キーボードショートカットを表示", "settings.shortcutsDescription": "?にポインターを合わせて表示",
