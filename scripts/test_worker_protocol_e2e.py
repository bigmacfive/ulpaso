...
from replay_meeting_worker import write_frame
...
WORKER = Path(
    os.environ.get(
        "ULPASO_WORKER_PATH",
        PROJECT_ROOT / "src-tauri/resources/asr/asr_worker.py",
    )
)
WORKER_PYTHON = os.environ.get("ULPASO_WORKER_PYTHON", sys.executable)
